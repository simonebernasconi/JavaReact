...
public class ExampleDiv implements ReactiveListener {
	...
	public static void main(String args[]) {
		...
		ReactiveDouble react= ReactiveFactory.getDouble("Remote1.obInt1.get() < Remote2.obInt2.get() ", "obDiv");
...
//		obAnd1.set(value.boolVal());
	...
	public void notifyReactiveUpdate(Value value) {
		System.out.println("1The reactive value is changed in: " + value.boolVal());
	}
}
